...
class BillController extends FOSRestController
{
    ...
    public function postBillAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //$clientName = $repository2->findBy(['name' => $name]);
           
            // $testClient =  getName();
            //$testEmailReminder = new Date() ;
            //$testCallReminder = 99;

           //$bill->setClient($testClient);
           //$bill->setEmailReminder($testEmailReminder);
           //$bill->setCallReminder($testCallReminder);
