...
export class CreateBillComponent implements OnInit {
  ...
  sendBill() {
    ...
    d1.className = "bye";
    d1.insertAdjacentHTML('afterend', ' <div class="preloader-wrapper big active"><div class="spinner-layer spinner-blue-only"><div class="circle-clipper left"> <div class="circle"></div></div><div class="gap-patch">    <div class="circle"></div></div><div class="circle-clipper right">  <div class="circle"></div></div></div></div>');
    ...
    this.Bill.status = 1;
    this.Bill.client = this.Project.name;
    ...
    if (this.Bill.payment_period == 2) {
      ...
      this.Bill.email_reminder = new Date();
      this.Bill.call_reminder = new Date();

      this.Bill.email_reminder.setDate(this.Bill.created_at.getDate()+15)
      this.Bill.call_reminder.setDate(this.Bill.created_at.getDate()+30)

      // console.log("test : date origine")
      // console.log(this.Bill.created_at)
      // console.log("test : email reminder")
      // console.log(this.Bill.email_reminder)
      // console.log("test : email reminder")
      // console.log(this.Bill.call_reminder)
